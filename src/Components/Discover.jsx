        ...
        <div className='w-11/12 mx-auto my-10'>
            <Link to="/gallery">
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5'>
                    <div className='items-center mt-28'> <h1 className="text-4xl font-bold">Go beyond your imagination!</h1>
                        <p className="py-6 font-bold">
                            Uncover the ideal experience tailored just for you with us!
                        </p>
                        <button className='btn bg-gradient-to-r from-purple-500 from-10% via-amber-500 via-30% to-emerald-500 to-90% text-white '>Explore <img src="https://img.icons8.com/?size=48&id=cg9cjgYky4Y8&format=gif" alt="Arrow icon!" /> </button></div>
