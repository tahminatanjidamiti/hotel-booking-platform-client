    ...
    const data = [
        {
            ...
            modalText: "Exclusive Summer Offer!",
        },
        {
            discount: "30%",
            ...
            modalText: "Exclusive Winter Offer!",
        },
        {
            discount: "20%",
            ...
            modalText: "Exclusive Thailand Offer!",
        },
        {
            discount: "30%",
            ...
            modalText: "Exclusive New Year Offer!",
        },
        {
            discount: "20%",
            ...
            modalText: "Exclusive Singapore Offer!",
        },
        {
            discount: "40%",
            ...
            modalImage: "https://i.ibb.co.com/c80cRZW/sandwiches-3470525-1280.jpg",
            modalText: "Exclusive Maldives Offer!",
        },
    ];
    return (
